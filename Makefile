...
all:
	g++ $(CPPFLAGS) -std=c++17 main.cpp stack.cpp LogLib.cpp

sanitize:
	clang++ -std=c++17 -fsanitize=address,alignment,bool,bounds,enum,float-cast-overflow,float-divide-by-zero,integer-divide-by-zero  main.cpp stack.cpp LogLib.cpp 
